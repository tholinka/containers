...
![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/tholinka/containers/release-scheduled.yaml?style=for-the-badge&label=Scheduled%20Release)

</div>

Welcome to my container images, if looking for a container start by [browsing the GitHub Packages page for this repo's packages](https://github.com/tholinka?tab=packages&repo_name=containers).
...
| Container                                          | Immutable |
|----------------------------------------------------|-----------|
| `ghcr.io/tholinka/nfs-server:rolling`                   | ❌         |
| `ghcr.io/tholinka/nfs-server:2.6.4`                | ❌         |
| `ghcr.io/tholinka/nfs-server:rolling@sha256:8053...`    | ✅         |
| `ghcr.io/tholinka/nfs-server:2.6.4@sha256:8053...` | ✅         |
